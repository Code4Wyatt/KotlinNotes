/**
 * Program that implements classes for different kinds of dwellings. Shows how to: Create class
 * hierarchy, variables and functions with inheritance, abstract class, overriding, and private vs.
 * public variables.
 */
...
/**
 * Defines properties common to all dwellings. All dwellings have floorspace, but its calculation is
 * specific to the subclass. Checking and getting a room are implemented here because they are the
 * same for all Dwelling subclasses.
 *
...
abstract class Dwelling(private var residents: Int) {
    ...
    /**
     * Calculates the floor area of the dwelling. Implemented by subclasses where shape is
     * determined.
     *
     * @return floor area
     */
    ...
    /**
     * Compares the capacity to the number of residents and if capacity is larger than number of
     * residents, add resident by increasing the number of residents. Print the result.
     */
    fun getRoom() {
...
class RoundTower(residents: Int, radius: Double, val floors: Int = 2) :
    ...
    /**
     * Calculates the total floor area for a tower dwelling with multiple stories.
     *
     * @return floor area
     */
    override fun floorArea(): Double {
...
/* In this codelab I learned how to:
